...
// CHECK:           %[[VAL_1:.*]] = cuttingbored.column : () -> <5 x 1 : [0, 0, 0, 0, 0]>
// CHECK:           %[[VAL_2:.*]] = cuttingbored.insert_column %[[VAL_0]], %[[VAL_1]] : (<5 x 2 : [0, 2, 1, 3, 2]>, <5 x 1 : [0, 0, 0, 0, 0]>) -> <5 x 3 : [0, 4, 2, 6, 4]>
...
// CHECK:           %[[VAL_5:.*]] = cuttingbored.column : () -> <5 x 1 : [0, 0, 0, 0, 0]>
// CHECK:           %[[VAL_6:.*]] = cuttingbored.insert_column %[[VAL_4]], %[[VAL_5]] : (<5 x 3 : [0, 1, 2, 3, 4]>, <5 x 1 : [0, 0, 0, 0, 0]>) -> <5 x 4 : [0, 1, 2, 3, 4]>
// CHECK:           %[[VAL_7:.*]] = cuttingbored.column : () -> <5 x 1 : [0, 0, 0, 0, 0]>
// CHECK:           %[[VAL_8:.*]] = cuttingbored.insert_column %[[VAL_6]], %[[VAL_7]] : (<5 x 4 : [0, 1, 2, 3, 4]>, <5 x 1 : [0, 0, 0, 0, 0]>) -> <5 x 5 : [0, 1, 2, 3, 4]>
